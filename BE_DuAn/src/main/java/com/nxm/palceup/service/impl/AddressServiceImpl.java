...
import com.nxm.palceup.repositories.AddressRepository;
import com.nxm.palceup.dto.AddressDTO;
import com.nxm.palceup.service.AddressService;
...
public class AddressServiceImpl implements AddressService {
    ...
    public ResponseEntity<?> getDistrict(String id) {
        return restTemplate.exchange("https://dev-online-gateway.ghn.vn/shiip/public-api/master-data/district?province_id="+id,
                HttpMethod.GET, httpEntity, Object.class);
    }

    @Override
    public ResponseEntity<?> getWard(String id) {
        return restTemplate.exchange("https://dev-online-gateway.ghn.vn/shiip/public-api/master-data/ward?district_id="+id,
                HttpMethod.GET, httpEntity, Object.class);
    }
    ...
    public ResponseEntity<?> getShippingOrder(String from_district_id, String service_id
        ...
        return restTemplate.exchange("https://dev-online-gateway.ghn.vn/shiip/public-api/v2/shipping-order/fee?from_district_id="
